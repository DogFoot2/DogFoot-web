...
public class BoardDAO {
	...
	/**
	 * 게시물번호 추출(seq_tbl_board_no) 리턴값이 board 번호이기 때문에 int값
	 */
	...
	public void insertFile(BoardFileVO fileVO) {
		StringBuilder sql = new StringBuilder();
		sql.append(
				"insert into tbl_board_file(no, board_no, file_ori_name, file_save_name, file_size)values(seq_tbl_board_file_no.nextval, ?, ?, ?, ?) ");
